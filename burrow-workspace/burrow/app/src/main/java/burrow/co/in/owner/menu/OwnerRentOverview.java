...
import burrow.co.in.owner.adapter.RentOverviewAdapter;


public class OwnerRentOverview extends AppCompatActivity {

    private Toolbar mtoolbar;
    RentOverviewAdapter rentOverviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.owner_rent_overview);
        ...
        expListView = (ExpandableListView) findViewById(R.id.rentExpandableListView);

        // preparing list data
        prepareListData();

        rentOverviewAdapter = new RentOverviewAdapter(this, listDataHeader, listDataChild);

        // setting list adapter
        expListView.setAdapter(rentOverviewAdapter);
