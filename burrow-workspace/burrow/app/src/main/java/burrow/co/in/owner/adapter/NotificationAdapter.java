...
public class NotificationAdapter extends BaseExpandableListAdapter {
    ...
    public NotificationAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.owner_notifiction_item, null);
            convertView.setPadding(20, -5, 20, 0);
        }


        TextView txtListChild = (TextView) convertView.findViewById(R.id.notifierName);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.owner_notification_child, null);
        }
