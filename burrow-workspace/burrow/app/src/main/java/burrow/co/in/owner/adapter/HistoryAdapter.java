...
public class HistoryAdapter extends BaseExpandableListAdapter {
    ...
    public HistoryAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.owner_send_history_item, null);
        }


        TextView txtListChild = (TextView) convertView
                .findViewById(R.id.historySubject);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.owner_send_history_child, null);
        }
